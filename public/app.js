...
// ============= DEV REF DATA =============
const DEV={
motor_gross:{t:"Motricité globale",ico:"run",bg:"var(--sk)",c:"var(--sk3)",ages:{"0-6m":[{l:"Tient sa tête, soulève le buste sur le ventre",acts:["Tummy time : 2-3 min sur le ventre après chaque change","Portage vertical pour renforcer les muscles du cou","Jeu du miroir : allonge sur le ventre face à un miroir"]},{l:"Se retourne du ventre sur le dos",acts:["Attirez-le sur le côté avec un jouet musical","Roulade douce guidée avec vos mains","Surface légèrement inclinée avec un coussin"]}],"6-12m":[{l:"S'assoit seul, rampe, quatre pattes",acts:["Parcours de coussins au sol pour ramper","Tunnel avec une grande boîte en carton","Jouets places hors de portée pour motiver"]},{l:"Se met debout en s'accrochant",acts:["Table basse stable pour se hisser","Dansez debout en le tenant par les mains","Jouets poses sur le canapé pour l'attirer"]}],"1-2a":[{l:"Premiers pas, commence à courir",acts:["Promenade pieds nus dans l'herbe","Jeu de la balle à rouler puis lancer","Mini parcours d'obstacles dans le salon"]},{l:"Monte les escaliers à quatre pattes",acts:["Accompagnez-le dans les escaliers (supervisé)","Montagne de matelas pour grimper","Escalade douce sur les coussins"]}],"2-3a":[{l:"Court, saute à pieds joints, pedale",acts:["Course dans le jardin avec obstacles","Sauter dans les flaques avec des bottes","Premier tricycle où draisienne au parc"]},{l:"Monte les marches en alternant",acts:["Marelle simplifiée","Parcours au parc avec pentes","Danse rythmée avec sauts"]}],"3-6a":[{l:"Vélo, corde a sauter, équilibre",acts:["Velo avec puis sans stabilisateurs","Parcours d'agilité au parc","Jeu de la statue"]},{l:"Nage, sports collectifs",acts:["Cours de natation dès 4 ans","Football où basket en famille","Jeux de ballon entre copains"]}]}},
motor_fine:{t:"Motricité fine",ico:"hand",bg:"var(--lv)",c:"var(--lv3)",ages:{"0-6m":[{l:"Ouvre les mains, attrape un objet",acts:["Hochets légers de différentes textures","Chaussette coloriée sur la main","Mobile a portee de main"]}],"6-12m":[{l:"Pince pouce-index, tape deux objets",acts:["Petits morceaux de nourriture (finger food)","Boîtes à ouvrir et fermer","Transvasement de gros haricots entre bols"]}],"1-2a":[{l:"Empile des cubes, gribouille, cuillère",acts:["Tour de cubes : la plus haute !","Premiers crayons gras sur grande feuille","Jeux d'eau : verser et transvaser"]}],"2-3a":[{l:"Dessine un cercle, découpe, boutonne",acts:["Pâte à modeler : boudins et boules","Collage de gommettes","Jeux de lacage avec cartes perforées"]}],"3-6a":[{l:"Bonhomme, prénom, découpage precis",acts:["Perles à enfiler pour colliers","Origami simple (avion, bateau)","Cuisine : decorer des biscuits"]}]}},
language:{t:"Langage",ico:"speech",bg:"var(--pk)",c:"var(--pk3)",ages:{"0-6m":[{l:"Gazouillis, rires, réagit aux voix",acts:["Parlez de tout ce que vous faites","Chantez berceuses et comptines","Imitez ses sons : dialogue de babillage"]}],"6-12m":[{l:"Babillage, premiers mots, pointe",acts:["Nommez tout ce que vous montrez","Lecture interactive avec images","Coucou-cache avec des mots"]}],"1-2a":[{l:"50 à 200 mots, associe 2 mots",acts:["Livres à volets et textures","Jeu 'Où est le...?'","Chansons à gestes (Ainsi font font font)"]}],"2-3a":[{l:"Phrases de 3-4 mots, questions",acts:["Racontez votre journée au dîner","Devinettes simples","Inventer une histoire a partir d'images"]}],"3-6a":[{l:"Phrases complexes, récits",acts:["Histoires inventees avant le coucher","Jeux de rimes et sons","Théâtre de marionnettes"]}]}},
cognitive:{t:"Cognitif",ico:"brain",bg:"var(--mt)",c:"var(--mt3)",ages:{"0-6m":[{l:"Suit des yeux, explore avec la bouche",acts:["Mobile contraste noir/blanc (0-2 mois)","Jeu du miroir","Hochets sonores pour cause et effet"]}],"6-12m":[{l:"Permanence de l'objet, cause et effet",acts:["Coucou-cache sous une couverture","Boîte à formes simples","Cacher un jouet sous un tissu"]}],"1-2a":[{l:"Jeu symbolique, tri par formes",acts:["Dinette et telephone jouet","Puzzles 2-4 pièces en bois","Tri de couleurs avec objets du quotidien"]}],"2-3a":[{l:"Compte jusqu'à 5, couleurs",acts:["Compter les marches en montant","Chasse aux couleurs dans la maison","Puzzles de 6-10 pieces"]}],"3-6a":[{l:"Raisonnement logique, planification",acts:["Jeux de société (loto, memory)","Circuits de billes","Expériences simples (volcan, fleurs coloriées)"]}]}},
social:{t:"Socio-émotionnel",ico:"smile",bg:"var(--rs)",c:"var(--rs3)",ages:{"0-6m":[{l:"Sourire social, attachement",acts:["Peau-à-peau quotidien","Massage bébé","Répondre aux pleurs = confiance"]}],"6-12m":[{l:"Angoisse de séparation, joie",acts:["Coucou pour la séparation","Rencontres avec d'autres bébés","Toujours dire au revoir"]}],"1-2a":[{l:"Empathie naissante, crises",acts:["Nommez les émotions","Livres sur les émotions","Coin calme avec coussins et doudou"]}],"2-3a":[{l:"Jeu coopératif, premiers amis",acts:["Jeux de rôle : docteur, marchand","Inviter un ami a la maison","Tour de rôle avec un jeu"]}],"3-6a":[{l:"Négociation, empathie, règles",acts:["Jeux pour apprendre à perdre","Fort en coussins ensemble","Discussions sur les émotions"]}]}},
autonomy:{t:"Autonomie",ico:"star",bg:"var(--sd)",c:"var(--sd3)",ages:{"0-6m":[{l:"Tient son biberon, coopère habillage",acts:["Laissez tenir le biberon","Décrivez chaque geste d'habillage","Routine prévisible"]}],"6-12m":[{l:"Mange avec les doigts, gobelet",acts:["Finger food adapté","Gobelet a bec puis ouvert","Brosse a dents a mordiller"]}],"1-2a":[{l:"Cuillère, aide au déshabillage",acts:["Manger seul (le bazar fait partie de l'apprentissage)","Chaussures a scratch","Ranger dans la boite ensemble"]}],"2-3a":[{l:"Propreté, s'habille avec aide",acts:["Pot accessible, valoriser succès","Choisir ses vetements (2 options)","Se laver les mains seul"]}],"3-6a":[{l:"S'habille seul, range, cuisine",acts:["Tableau routines matin/soir","Préparer son sac d'école","Cuisiner un goûter simple"]}]}}
};
...
{t:'DME - diversification menée',a:'6-12 mois',x:'Bébé mange seul à la main. Morceaux de la taille du poing (banane, avocat, courgette vapeur). On vous conseille de toujours rester présent avec lui pendant qu\'il mange. Formation aux gestes d\'urgence recommandée.'},
{t:'Les allergènes prioritaires',a:'4-12 mois',x:'Introduisez tôt : arachide (purée diluée), œuf bien cuit, gluten, poisson. Plus tôt = moins de risque d\'allergie (étude LEAP).'},
...
{t:'Sucres et sel',a:'0-2 ans',x:'Pas de sel ajouté avant 1 an (reins immatures). Pas de miel avant 1 an (botulisme). Sucre : limitez le plus possible avant 2 ans.'},
...
{t:'Les aliments à risque d\'étouffement',a:'0-4 ans',x:'Évitez : cacahuètes entières, raisins entiers (coupez en 4), saucisses rondelles, bonbons durs, pop-corn. Plutôt en longueur qu\'en rondelles.'},
...
{t:'Tempêtes émotionnelles',a:'18m-4 ans',x:'Le cerveau de votre enfant est encore immature : il ne peut pas encore réguler seul ses émotions. Restez calme, à sa hauteur, nommez l\'émotion ("tu es en colère"). Câlinez quand il est prêt. Ne raisonnez pas pendant la crise.'},
...
{t:'La séparation',a:'8m-3 ans',x:'Pic d\'angoisse de séparation entre 8 et 18 mois. Dites toujours au revoir franchement (ne partez pas en cachette). Un objet transitionnel (doudou, petit foulard avec l\'odeur de la maison) fait le lien entre la maison et le lieu de garde et apaise la transition. Rassurez sur le retour.'},
{t:'Les écrans',a:'Règle 4-6-9-12',x:'Pas d\'écran avant 3 ans. Pas de console avant 6 ans. Pas d\'internet seul avant 9 ans. Pas de réseaux sociaux avant 12 ans (recommandations Serge Tisseron).'},
