...
window.showDevDetail=function(key){
  ...
  document.getElementById('gdh').style.background='radial-gradient(110% 80% at 100% 0%,rgba(255,255,255,.55) 0%,rgba(255,255,255,.18) 32%,transparent 65%),linear-gradient(135deg,transparent 0%,transparent 55%,rgba(0,0,0,.22) 100%),'+_devC;
...
window.showGD=function(key){const g=GUIDE[key];if(!g)return;
  ...
  document.getElementById('gdh').style.background='radial-gradient(110% 80% at 100% 0%,rgba(255,255,255,.55) 0%,rgba(255,255,255,.18) 32%,transparent 65%),linear-gradient(135deg,transparent 0%,transparent 55%,rgba(0,0,0,.22) 100%),'+g.c;
  document.getElementById('gdh').style.color='#fff';
